...
function placeXOrO(squareNumber) {
 ...
 function computersTurn() {
     //This boolean is needd for our while loop.
     let success = false;
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        // If the 3 variables we pass are a;ll included in our array true is 
...
function disableClick() {
    //This makes our body unclikable.
...
function animateLineDrawing() {
    ...
    //This method clears content from last loop iteraction.
    ...
    if (x1 <= x2 && y1 <= y2) {
        //Thsi condition adds 10 to the previous end x point.
        if (x < x2) { x += 10; }
        //This condition adds 10 to the previous wnd y point.
        if (y < y2) { y += 10; }
